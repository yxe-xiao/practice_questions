...
import com.yxe.practice.model.dto.question.QuestionAddRequest;
import com.yxe.practice.model.dto.question.QuestionEditRequest;
...
public class QuestionController {
    ...
    public BaseResponse<QuestionVO> getQuestionVOById(long id, HttpServletRequest request) {
        ThrowUtils.throwIf(id <= 0, ErrorCode.PARAMS_ERROR); // id 校验
        // 查询数据库
